    ...
    <div className="mx-auto max-w-2xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mt-6 border border-red-200 bg-red-50 p-4 text-sm text-red-800">
        ...
        <ul className="mt-2 list-disc space-y-1 pl-5 text-xs">
          <li>登録された氏名・メール・電話・住所・履歴書情報は速やかに匿名化されます。</li>
          <li>過去の応募履歴は企業の業務記録として残りますが、企業側からあなたを特定する情報は表示されなくなります。</li>
          <li>お気に入り・保存検索・フォロー企業・通知は完全に削除されます。</li>
          <li>同じメールアドレスでの再登録は退会後 30 日経過後に可能です。</li>
        </ul>
      </div>
